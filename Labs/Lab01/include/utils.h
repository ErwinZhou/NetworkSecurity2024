...
void SilentGuardian(int role, Agent agent, DESUtils des);   // Special Operation: Communication between Agent and Headquarter with DES encryption to protect the secret