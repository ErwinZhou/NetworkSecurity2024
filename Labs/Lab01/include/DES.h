...
public:
    ...
    const uint8_t ip_reverse[64] = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31,
    ...
    const uint8_t PC1[56] = {57, 49, 41, 33, 25, 17, 9,
                             ...
                             14, 6, 61, 53, 45, 37, 29,
                             21, 13, 5, 28, 20, 12, 4};
    const uint8_t shiftBits[16] = {1, 1, 2, 2, 2, 2, 2, 2,
                                   1, 2, 2, 2, 2, 2, 2, 1};
    const uint8_t PC2[48] = {14, 17, 11, 24, 1, 5, 3, 28,
    ...
    INT32 padding(vector<uint8_t> &data);
    INT32 unpadding(vector<uint8_t> &data);
